...
export function Receipt({ cobranca }: { cobranca: Cobranca }) {
    return (
        <div className="bg-white text-black font-mono text-sm font-bold p-2">
            <div className="text-center mb-4 space-y-2">
                <div className="flex justify-center">
                    <AppLogo className="text-black" logoBoxCn="bg-black text-white" logoTextCn="text-black" />
                </div>
                <p>SUA SORTE VALE MUITO!!</p>
                <p className="font-normal">JAGUAPITA-PR</p>
                <p>----------------------------------------</p>
            </div>
            
            <div className="space-y-1 mb-2">
                <p><span>Cliente:</span> {cobranca.clientName}</p>
                <p><span>Data:</span> {formatDate(cobranca.createdAt)}</p>
            </div>

            <div className="border-t border-b border-dashed border-black py-2 my-2 space-y-1">
                <h3 className="text-center mb-2">DETALHES DA COBRANÇA</h3>
            ...
            {cobranca.prizesGiven && cobranca.prizesGiven.length > 0 && (
                <div className="border-b border-dashed border-black pb-2 mb-2 space-y-1">
                    <h3 className="text-center mb-2">PRÊMIOS ENTREGUES</h3>
            ...
            <div className="text-center mt-4 space-y-2">
                ...
                <p>----------------------------------------</p>
                <p className="font-normal">Obrigado pela preferência!</p>
            </div>
        </div>
    );
}
